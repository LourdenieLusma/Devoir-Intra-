...
class FakeDatabase {
  static Map<String, String> users = {"bervelie@gmail.com": "12345678"};
}
    ...
    if (_formKey.currentState!.validate()) {
      ...
      if (FakeDatabase.users.containsKey(email) &&
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (_) => const MyHomePage(title: 'MovieFinder App'),
          ),
        );
      } else {
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                focusedBorder: OutlineInputBorder(
                  ...
                  borderSide: const BorderSide(
                    color: Color.fromARGB(255, 22, 80, 140),
                    width: 2,
                  ),
                ),
              ),
